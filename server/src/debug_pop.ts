    ...
    try {
        ...
        for (const order of orders) {
            ...
            for (let i = 0; i < order.items.length; i++) {
                ...
                const model = (item.model_type === 'Product' ? Product : OliveCategory) as mongoose.Model<any>;
                ...
                if (doc) {
                    ...
                    const altModel = (item.model_type === 'Product' ? OliveCategory : Product) as mongoose.Model<any>;
